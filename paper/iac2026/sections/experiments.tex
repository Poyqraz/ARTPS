...
Until a frozen test split is opened, this track remains
\texttt{protocol\_defined\_pending\_data} for headline \texttt{IND\_EVAL\_V1} reporting:
no fabricated $N$, no invented test metrics.
