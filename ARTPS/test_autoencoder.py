"""
ARTPS - Autoencoder Model Test Scripti

Bu script, Convolutional Autoencoder modelini test etmek için kullanılır.
...
sys.path.append('src')
from models.autoencoder import ConvolutionalAutoencoder, AutoencoderTrainer, MarsRockDataset
...
def test_training():
    ...
    # Model oluştur
    model = ConvolutionalAutoencoder(input_channels=3, latent_dim=64)  # Test için daha küçük model
    ...
    trainer.save_model("results/test_autoencoder_model.pth")
...
def visualize_results(trainer):
    ...
    if len(dataset) > 0:
        ...
        from models.autoencoder import visualize_reconstruction
        visualize_reconstruction(trainer.model, sample_image, "results/test_reconstruction.png")
...
def main():
    """Ana test fonksiyonu"""
    print("🚀 ARTPS Autoencoder Model Testi Başlıyor...\n")
    ...
    try:
        ...
        print("  - results/test_autoencoder_model.pth: Eğitilmiş model")
        print("  - results/test_reconstruction.png: Yeniden oluşturma örneği")
