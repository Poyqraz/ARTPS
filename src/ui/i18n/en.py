...
MESSAGES: dict[str, str] = {
    ...
    "sidebar.model.detector": "✅ YOLO-like Detector (Optional)",
    "sidebar.depth_active": "Active Depth Model: {model_type} — Parameters: {param_count:,} — {quality}",
    "sidebar.depth_semantics": "This depth map is relative, not metric distance. Load source: {load_source}.",
    "sidebar.detector_active": "Active detector backend: {backend}",
    ...
    "models.detector_loaded": "ℹ️ YOLO-like detector loaded: {path}",
    "models.detector_missing": "ℹ️ YOLO-like detector weights not found (results/yolo_detector.onnx)",
    "models.detector_load_failed": "⚠️ Detector failed to load: {error}",
    ...
    "params.detection.backend_help": "Choose between the heuristic contour pipeline and the optional YOLO-like detector.",
    "params.detection.detector_conf": "Detector confidence threshold",
    "params.detection.detector_conf_help": "Initial proposal filtering threshold for the YOLO-like detector outputs.",
    ...
    "params.detection.beta_shadow_obj": "Object-in-Shadow Gate (β)",
    "params.detection.beta_shadow_obj_help": "Softens suppression in structured shadows e.g. rock bases (0 = legacy)",
    ...
    "analysis.enhance_mars_note": "Mars-safe profile: preserves the red surface cast (gray-world AWB off); contrast/sharpening are softened to support hybrid anomaly detection.",
    "analysis.opt_upscale": "Upscale",
    "analysis.opt_upscale_help": "Upscales low-res Mars images (artifact-prone detailEnhance disabled)",
    "analysis.opt_denoise": "Denoise",
    "analysis.opt_denoise_help": "Applied only when noise is high; kept mild to avoid erasing anomaly texture",
    "analysis.opt_clahe": "Contrast (CLAHE)",
    "analysis.opt_clahe_help": "Boosts local contrast in dusty/low-contrast Mars scenes (clip=1.5)",
    "analysis.opt_gamma": "Exposure (Gamma)",
    "analysis.opt_gamma_help": "Lifts dark scenes toward target brightness (~115) without over-brightening",
    "analysis.opt_sharp": "Sharpening",
    "analysis.opt_sharp_help": "Mild unsharp to aid edge-based detection while limiting false anomalies",
    "analysis.opt_realesrgan": "Real-ESRGAN (2×)",
    "analysis.opt_realesrgan_help": "Optional SR after denoise (RealESRGAN_x2plus). Weight: raw_models/RealESRGAN_x2plus.pth + pip realesrgan",
    "analysis.opt_realesrgan_risk": "Warning: GAN may invent texture and inflate anomaly scores; default is off.",
    "analysis.realesrgan_fallback": "Real-ESRGAN unavailable (missing package/weight); used CUBIC upscale.",
    "analysis.opt_shadow_preview": "Shadow visibility preview",
    "analysis.opt_shadow_preview_help": "Lifts rock-base shadows for human review; does not change analysis input",
    "analysis.opt_shadow_depth_gate": "Depth-gated shadow mask",
    "analysis.opt_shadow_depth_gate_help": "Weakens lift on depth edges (needs depth in session after analysis)",
    "analysis.shadow_depth_gate_skip": "No depth map; using RGB-only shadow mask.",
    "analysis.shadow_shared": "Shared (analysis)",
    "analysis.shadow_lifted": "Shadow lift (preview)",
    "analysis.shadow_mask": "Shadow mask",
    ...
    "analysis.viz_qc_fail": "QC failed (score {score:.0%}): {detail}",
    "analysis.viz_qc_none": "No messages",
    "analysis.viz_depth_rgb": "Depth-on-RGB",
    "analysis.viz_protrusion": "Local protrusion (Z-residual)",
    "analysis.viz_depth_edge": "Depth edge",
    "analysis.viz_missing_depth_rgb": "Depth-on-RGB missing",
    "analysis.viz_missing_protrusion": "Protrusion map missing",
    "analysis.viz_missing_depth_edge": "Depth edge missing",
    "analysis.viz_qc_render_error": "Depth QC panel failed to render: {error}",
    ...
    "depth.relative_notice": "This output is a relative depth map; 0=near and 1=far only apply within this image and do not represent metric distance. Source: {load_source}. Near/far confidence is lower in fallback mode.",
