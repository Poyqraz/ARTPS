...
class MiDaSDepthEstimator:
    ...
    @staticmethod
    def vectorize_depth_features(depth_features: Dict[str, float]) -> List[float]:
        """Sabit training/inference sirasi ile 14 depth ozelligi dondur."""
        return [float(depth_features.get(key, 0.0)) for key in DEPTH_FEATURE_KEYS]
